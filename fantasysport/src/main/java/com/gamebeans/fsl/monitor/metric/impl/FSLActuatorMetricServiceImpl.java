...
import com.gamebeans.fsl.monitor.metric.FSLActuatorMetricService;

@Service
public class FSLActuatorMetricServiceImpl implements FSLActuatorMetricService {
    ...
    public FSLActuatorMetricServiceImpl() {
        super();
